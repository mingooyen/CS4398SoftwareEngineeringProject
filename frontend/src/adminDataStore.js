/**
 * Admin-only local persistence (localStorage). Replace with API when backend admin routes exist.
 * Keys align with DATABASE ENGINEER notes in database/schema.prisma.
 */
