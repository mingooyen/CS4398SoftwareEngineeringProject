...
export const OFFLINE_MOVIES = [
  ...
  { id: 4935, title: "Howl's Moving Castle", year: 2004, rating: 8.4, genre: "Animation", posterPath: "/jpUeKgLmzuWGtjIEW0aBVsM6x82.jpg" },
...
/** @param {"default"|"rating"|"year"} offlineSort */
export function buildOfflineMovies(genreNames = [], limit = 50, offlineSort = "default") {
