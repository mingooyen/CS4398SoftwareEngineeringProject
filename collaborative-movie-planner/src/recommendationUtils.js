...
/**
 * Merges admin-added catalog titles with mock cards and ranks by overlap with group members' genre preferences.
 */
export function computeGroupRecommendations(activeGroup, mockRecommendations) {
  ...
  const combined = [...fromAdmin, ...mockRecommendations];
